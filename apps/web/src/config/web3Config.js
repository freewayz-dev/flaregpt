...
export function getFlarescanAddressUrl(address) {
...
export function getSongbirdExplorerAddressUrl(address) {
...
function findMetaMaskEip6963Provider() {
  const provider = mipdStore.findProvider({ rdns: "io.metamask" })?.provider;
