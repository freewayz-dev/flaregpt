...
import { useUIStore, type SpectraMarketSlug } from "@/store/useUIStore";
...
import type { SpectraVaultResponse } from "@/services/defiProtocolsService";
...
const MARKETS: { slug: SpectraMarketSlug; label: string }[] = [
...
export default function SpectraDetail({
  activeAddress,
  icon: Icon,
}: Pick<DetailComponentProps<SpectraVaultResponse>, "activeAddress" | "icon">) {
