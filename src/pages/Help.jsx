...
export default function Help() {
  ...
  const faqsList = useMemo(() => t("help.faqs", { returnObjects: true }) || [], [t]);
  const guidesList = useMemo(() => t("help.guides", { returnObjects: true }) || [], [t]);
  const stepsList = useMemo(() => t("help.steps", { returnObjects: true }) || [], [t]);
      ...
      <div className="flex-1 pb-16">
        ...
        <div className="mx-auto max-w-[1440px] sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
            ...
            <div className="relative z-10 max-w-xl">
              ...
              <div className="mt-4 relative rounded-xl shadow-sm w-full max-w-md">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                  <MagnifyingGlassIcon className="h-4 w-4 text-[#94A3B8] dark:text-[#71717A]" aria-hidden="true" />
                </div>
                <input
                  type="text"
                  value={searchQuery}
          ...
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-3">
            ...
            <div className="order-2 lg:order-1 lg:col-span-1 flex flex-col h-full rounded-2xl bg-[#FFFFFF] p-5 sm:p-6 shadow-sm border border-[#E5E7EB] dark:border-none dark:bg-[#161619]">
            ...
            <div className="order-1 lg:order-2 lg:col-span-2 flex flex-col h-full space-y-6">
              {/* Card Background - Card: #FFFFFF | Dark Card: #161619 */}
              <div className="flex-1 flex flex-col rounded-2xl bg-[#FFFFFF] p-5 sm:p-6 shadow-sm border border-[#E5E7EB] dark:border-none dark:bg-[#161619]">
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          ...
                          `}
                        >
                          <ChevronDownIcon className={`h-3.5 w-3.5 transition-transform duration-200 ease-out ${isOpen ? "rotate-180" : ""}`} />
                        </div>
                      </button>
