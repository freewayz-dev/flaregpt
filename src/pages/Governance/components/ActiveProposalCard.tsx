...
export default function ActiveProposalCard({ proposal, hasVoted, onOpenDetail }: ActiveProposalCardProps) {
...
function formatEndsIn(voteEndTimeSeconds: number, t: (key: string, opts?: Record<string, unknown>) => string) {
