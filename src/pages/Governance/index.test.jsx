...
const FIP_16_VOTES = [5_584_276_388_171_569_457_423_523_902n, 110_535_155_356_761_807_469_936_046n];
...
function mockGovernanceRpc({
  ...
  server.use(
    http.post(FLARE_RPC, async ({ request }) => {
...
function renderGovernance(wagmi) {
