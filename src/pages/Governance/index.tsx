...
const NETWORKS: GovernanceNetwork[] = ["flare", "songbird"];
...
export default function Governance() {
  ...
  const [network, setNetwork] = useState<GovernanceNetwork>("flare");
  ...
  const handleNetworkChange = (next: GovernanceNetwork) => {
