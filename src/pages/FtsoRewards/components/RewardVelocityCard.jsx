...
// `calculation_method` is treated as an open set (see deriveFtsoRewards.js)
...
function getMethodInfo(method, t) {
...
export default function RewardVelocityCard({ summary }) {
