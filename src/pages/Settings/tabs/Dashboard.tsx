...
const chartOptions: { value: ChartType; labelKey: string }[] = [
...
const timeframeOptions: { value: Timeframe; labelKey: string }[] = [
...
const landingPageOptions: { value: LandingPage; labelKey: string }[] = [
...
const densityOptions: { value: TableDensity; labelKey: string }[] = [
        ...
        >
          <div className="w-full sm:w-56">
            <CustomSelect
              ...
              onChange={(option) => setDefaultLandingPage(option.value as LandingPage)}
        ...
        >
          <div className="w-full sm:w-56">
            <CustomSelect
              ...
              onChange={(option) => setTableDensity(option.value as TableDensity)}
        ...
        >
          <div className="w-full sm:w-56">
            <CustomSelect
              ...
              onChange={(option) => setChartType(option.value as ChartType)}
        ...
        >
          <div className="w-full sm:w-56">
            <CustomSelect
              ...
              onChange={(option) => setTimeframe(option.value as Timeframe)}
            />
          </div>
        </RowItem>
      </div>
