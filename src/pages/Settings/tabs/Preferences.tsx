...
import { useUIStore, type BlueLightLevel, type Currency } from "@/store/useUIStore";
...
interface BlueLightOption {
  value: BlueLightLevel;
  labelKey: string;
}
...
export default function Preferences() {
  ...
  const blueLightOptions: BlueLightOption[] = [
  ...
  const handleBlueLightChange = (option: BlueLightOption) =>
    updateBlueLightLevel(option.value as BlueLightLevel);
        ...
        >
          <div className="w-full sm:w-56">
            <CustomSelect
              ...
              onChange={(option) => setCurrencyCode(option.value as Currency)}
