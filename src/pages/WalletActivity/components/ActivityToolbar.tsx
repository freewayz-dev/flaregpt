...
function Segmented<T extends string>({ options, value, onChange, getLabel = (o) => o }: SegmentedProps<T>) {
  return (
...
export default function ActivityToolbar({
  ...
  const sortOptions: SortKey[] = selectedAssets.size === 1 ? ["newest", "oldest", "amount"] : ["newest", "oldest"];
