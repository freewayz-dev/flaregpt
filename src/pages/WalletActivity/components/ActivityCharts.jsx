...
function AssetTick({ x, y, payload }) {
  return (
    <foreignObject x={x - 68} y={y - 9} width={64} height={18}>
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <BarChart layout="vertical" data={rows} margin={{ left: 8, right: 16, top: 4, bottom: 0 }}>
        ...
        <YAxis type="category" dataKey="asset" tick={<AssetTick />} axisLine={false} tickLine={false} width={72} />
        <Tooltip content={<CountTooltip />} cursor={{ fill: "rgba(148,163,184,0.08)" }} />
...
export default function ActivityCharts({ dailyHistogram, assetBreakdown, actionBreakdown }) {
