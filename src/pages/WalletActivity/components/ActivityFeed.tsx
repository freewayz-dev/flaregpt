...
import type { ActivityItem, DayGroup } from "@/pages/WalletActivity/utils/deriveActivity";
...
type FlatItem =
  ...
  | { kind: "row"; key: string; item: ActivityItem };
...
export default function ActivityFeed({ groups, selectedActionId, onSelect, totalCount, shownCount }: ActivityFeedProps) {
