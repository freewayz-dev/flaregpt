...
import type { VestingSummary } from "@/pages/RflrVesting/utils/deriveVesting";

interface VestingOverviewStatsProps {
...
export default function VestingOverviewStats({ summary }: VestingOverviewStatsProps) {
