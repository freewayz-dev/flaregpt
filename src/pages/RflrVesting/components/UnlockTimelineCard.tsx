...
import type { UnlockTimeline, UnlockPoint, MeltScheduleRow } from "@/pages/RflrVesting/utils/deriveVesting";
...
function pickTicks(points: UnlockPoint[], count = 6) {
...
interface UnlockTimelineCardProps {
  timeline: UnlockTimeline | null;
  rawRows: MeltScheduleRow[];
  isLoading: boolean;
  isError: boolean;
  isFetching: boolean;
  onRetry: () => void;
