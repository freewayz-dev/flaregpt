...
import type { VestingSummary, UnlockPoint } from "@/pages/RflrVesting/utils/deriveVesting";

interface VestingProgressCardProps {
  summary: VestingSummary;
  nextUnlock: UnlockPoint | null;
  isNextUnlockLoading: boolean;
}
...
export default function VestingProgressCard({
  summary,
  nextUnlock,
  isNextUnlockLoading,
}: VestingProgressCardProps) {
