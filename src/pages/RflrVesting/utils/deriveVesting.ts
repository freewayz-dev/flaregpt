...
import type { ExitQuoteResponse, MeltScheduleResponse } from "@/services/rflrService";
...
export function computeVestingSummary(exitQuote: ExitQuoteResponse): VestingSummary {
...
export function computeUnlockTimeline(
  meltSchedule: MeltScheduleResponse | undefined,
): UnlockTimeline {
  ...
  const points: UnlockPoint[] = Array.from(byDate.entries())
