...
export const ROUTES = {
  ...
  links: `${APP_ROOT}/${APP_SEGMENTS.links}`,
  fire: `${APP_ROOT}/${APP_SEGMENTS.fire}`,
  fassets: `${APP_ROOT}/${APP_SEGMENTS.fassets}`,
  transactionLookup: `${APP_ROOT}/${APP_SEGMENTS.transactionLookup}`,
