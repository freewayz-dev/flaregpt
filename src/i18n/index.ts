...
type LocaleResources = typeof enResources;

const localeLoaders: Record<string, () => Promise<{ default: LocaleResources }>> = {
...
export async function initI18n() {
  const resources: Record<string, { translation: LocaleResources }> = {
