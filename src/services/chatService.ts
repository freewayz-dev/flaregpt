...
export async function createConversation(title?: string | null): Promise<ConversationSummary> {
...
export async function clearAllConversations(): Promise<{ status: string }> {
