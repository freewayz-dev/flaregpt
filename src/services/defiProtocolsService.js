...
export async function fetchMxrpyVault(walletAddress, signal) {
...
export async function fetchSceptreVault(walletAddress, signal) {
...
export async function fetchFirelightVault(walletAddress, signal) {
...
export async function fetchSpectraVault(walletAddress, market, signal) {
...
export async function fetchCompareStrategies(amountFlr, signal) {
