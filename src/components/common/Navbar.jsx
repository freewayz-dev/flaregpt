...
export default function Navbar({
  ...
  return (
    <>
      ...
      <header className="z-30 h-12 w-full grid grid-cols-3 lg:flex lg:items-center lg:justify-between px-2 xl:px-4 bg-transparent transition-colors duration-200">
