...
interface NavbarProps {
  onToggleFlareWidget: () => void;
  setSidebarOpen: (value: boolean) => void;
  onOpenWalletModal: () => void;
  hideAskFlareGpt?: boolean;
}
...
export default function Navbar({
  ...
  const handleSwitchActive = (address: string) => {
  ...
  const buttonBadge: { text: string; tone: WalletBadgeTone } | null = activeWalletNeedsSignIn
