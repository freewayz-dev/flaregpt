...
export function useMxrpyVault(walletAddress: string | undefined, { enabled = true }: VaultQueryOptions = {}) {
  return useQuery({
...
export function useSceptreVault(walletAddress: string | undefined, { enabled = true }: VaultQueryOptions = {}) {
  return useQuery({
...
export function useFirelightVault(walletAddress: string | undefined, { enabled = true }: VaultQueryOptions = {}) {
  return useQuery({
...
export function useSpectraVault(
  ...
  market: string,
  { enabled = true }: VaultQueryOptions = {},
) {
  return useQuery({
...
export function useCompareStrategies(amountFlr: number) {
  return useQuery({
